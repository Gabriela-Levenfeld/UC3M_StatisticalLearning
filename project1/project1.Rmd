...
We configure a common train control parameter.

```{r}
# Set up train control -> 5 repeats of 10-fold cross validation
train_ctrl <- trainControl(method = "repeatedcv",
                           repeats = 5,
                           number = 10) # Resolve class imbalances

# "smote" require the themis packages
```
...
train_ctrl_balanced <- trainControl(method = "repeatedcv",
                                    repeats = 5,
                                    number = 10,
                                    sampling = "down") # Resolve class imbalances
