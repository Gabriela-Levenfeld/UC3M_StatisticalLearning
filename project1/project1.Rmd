...
# Postior probabilities
post_prob_LDA = predict(model_LDA, training_transf)$posterior
head(post_prob_LDA)

# LDA into labels 
predictions_LDA =predict(model_LDA, training_transf)$class 
...
# Performance measures
confMat_LDA=table(predictions_LDA, training_transf$Churn)
confMat_LDA
error_LDA=(n-sum(diag(confMat_LDA)))/n
error_LDA #20.44%
```
