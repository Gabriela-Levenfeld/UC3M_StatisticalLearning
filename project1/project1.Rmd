...
sprintf("Error for LDA: %f", error_LDA)

# Test accuracy
acc_test_LDA <- sum(diag(confMat_LDA)) / n_test
sprintf("Accuracy for LDA: %f", acc_test_LDA)
```
...
sprintf("Error for Naïve Bayes: %f", error_NB)

# Test accuracy
acc_test_NB <- sum(diag(confMat_NB)) / n_test
sprintf("Accuracy for Naïve Bayes: %f", acc_test_NB)
```
...
sprintf("Error for Logistic regression: %f", error_LR)

# Test accuracy
acc_test_LR <- sum(diag(confMat_LR)) / n_test
sprintf("Accuracy for Logistic regression: %f", acc_test_LR)
```
